...
//com.polarbear.sep302.calc - O
//com.polarbear.calc - X
//com.calc - X
//calc - X

//이를 통해서 controller 기능을 할 수 있다.
@Controller
...
//	
	...
	@RequestMapping(value="/calculate.do", method=RequestMethod.POST)
	public String calcXY(CalcResult cr, HttpServletRequest request) {
		
		//CalcDAO cd = new CalcDAO();
		
		//cd.calculate(cr, request);
		cDAO.calculate(cr, request);
		return "index";
	}
