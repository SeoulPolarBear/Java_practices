...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		return "home";
		//return "home";는 servlet-context.xml의 beans에서
		//prefix인 "/WEB-INF/views/"와 중간 경로인 "home"과
		// suffix인 ".jsp"가 합쳐져서
		// /WEB-INF/views/home.jsp라는 view파일 경로로 이동해서 
		//클라이언트에게 응답을 해주는 형태	
...
//		<beans:property name="suffix" value=".jsp" />
		...
		//@: Annotation
		//사전적 의미 : '주석'
		//	코드사이에 주석 처럼 쓰이며 기능을 수행하도록 하는 기술
		...
		//				타임에 따라서 Bean을 주입해 준다.
		//		3. @Controller : Spring의 Controller
		//				view(화면, .jsp)을 return해주는게 목적!
		//		4. @RestController : Controller 중에서 View쪽으로 응답하지 않는
		//				Controller
