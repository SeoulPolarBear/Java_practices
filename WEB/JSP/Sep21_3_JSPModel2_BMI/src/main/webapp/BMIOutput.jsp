...
<body>
	...
	<table id ="table-total">
		...
		<tr>
			...
			<td class="contents"><h1>${guest.name}</h1>
				<br></td>
		</tr>
		<tr>
			<td class="category" >키 :</td>
			<td class="contents"><h1>${guest.height}</h1>
				<br></td>
		</tr>
		<tr>
			<td class="category">몸무게 :</td>
			<td class="contents"><h1>${guest.weight}</h1>
				<br></td>
		</tr>
		<tr>
			<td class="category">사진</td>
			<td class="contents"><img class = "photos" src="img/${guest.photo}"><br></td>
		</tr>
		<tr>
